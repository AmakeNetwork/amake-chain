use amake_runtime::{
	...
	StakerStatus, StakingConfig, SudoConfig, SystemConfig, TechnicalCommitteeConfig, MAX_NOMINATIONS,
};
...
pub use amake_primitives::{constants::currency::*, AccountId, Balance, Signature};
pub use amake_runtime::GenesisConfig;
...
pub fn testnet_genesis(
	...
	GenesisConfig {
		...
		babe: BabeConfig {
			authorities: vec![],
			epoch_config: Some(amake_runtime::BABE_GENESIS_EPOCH_CONFIG),
		},
